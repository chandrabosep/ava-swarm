...
export function RightRail() {
  return (
    <aside className="w-80 shrink-0 border-l border-border h-[calc(100vh-3.5rem)] sticky top-14 p-4 overflow-y-auto">
      ...
      <Surface className="p-4 text-xs text-fg-subtle">
        No live intents. The router will populate this stream once agents come
        online.
      </Surface>
    </aside>
  );
